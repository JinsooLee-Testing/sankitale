...
public:
	...
	bool keyPressed(const OIS::KeyEvent &evt)
	{
		...
		{ 
			mProfessorNode->setOrientation(Ogre::Quaternion::IDENTITY); 
			Quaternion z(Degree(90), Vector3::UNIT_Z); Quaternion x(Degree(90), 
				Vector3::UNIT_X); Quaternion p = x * z; 
		...
		{ 
			mProfessorNode->setOrientation(Ogre::Quaternion::IDENTITY); 
			Quaternion z(Degree(90), Vector3::UNIT_Z); 
			Quaternion x(Degree(90), Vector3::UNIT_X); Quaternion p = z * x; 
			mProfessorNode->rotate(p); 
		} 
		break; 
		case OIS::KC_4: 
		...
		break; 
		case OIS::KC_R: mProfessorNode->setOrientation(Ogre::Quaternion::IDENTITY); break;
